% here I introduced specific fcn for each step (model fit and deformation)
% % according to the state of london
...
mainOutputFolderName='2-output_Demo';
outputFolderName_thisCase='3-testDef_fcn'; % to evaluate outputs from different tests/improvements/settings

makeMovie=1; % boolean for geneerating movies of iteration plots
doSave=1; % for saving all variables at the end of th emain loop
%% --input
% input data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% -- settings
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sd    = spm_noise_estimate(thisSubjFiles);
s     = mean(sd.^2);
...
% artifacts
regsc    = ones(numel(T)+1,1)*10; % intercept regulariztion
regsc(1) = 10; % regulraz of decay map
...
for it=1:nits
    ...
    [Ell,llr,Theta] = updateModelFit (Nii,mapIdx,s,Theta,T,Nii(1),V,reg,regsc,'axesHdl',axesHdl{1}(2:4),'timePoint_step',timePoint_step);
